...
export default function Home() {
  ...
  const totalIncome = walletMetrics ? displayMetric(metricNumber(walletMetrics.totalCommission) + metricNumber(walletMetrics.monthlyStars) * 0.015 + metricNumber(walletMetrics.nzrExchangeNetUsd), "$") : "—";
...
function FinancePanel({ walletMetrics }: { walletMetrics: WalletMetrics | null }) {
  ...
  const totalIncome = walletMetrics ? metricNumber(walletMetrics.totalCommission) + starsUsd + exchangeNetUsd : null;
  return <section className="finance-page">
